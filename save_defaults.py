...
BASE_DIR = os.path.abspath(os.path.dirname(__file__))
os.chdir('inputfiles/')
default_general().to_csv('default_general.csv', index='vars', sep=';')
default_compact().to_csv('default_compact.csv', index='vars', sep=';')
default_suv().to_csv('default_suv.csv', index='vars', sep=';')
default_ldv().to_csv('default_ldv.csv', index='vars', sep=';')
x_vals().to_csv('x_vals.csv', index='Class', sep=';')
spec_vals().to_csv('spec_vals.csv', index='Class', sep=';')
